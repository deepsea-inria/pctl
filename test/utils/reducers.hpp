...
void scan_exclusive(Array<Item>& items, size_t l, size_t r, ResultArray<Item>& result, size_t result_offset, TmpArray<Item>& tmp_array, size_t tmp_offset, const Item& zero, const Multiply_fct& multiplication) {
  size_t blocks = (r - l + BLOCK_SIZE - 1) / BLOCK_SIZE;
  if (blocks == 1) {
    scan_exclusive_serial(items, l, r, result, result_offset, zero, multiplication);
    return;
  }
...
template <template <class Item> class Array, template <class Item> class TmpArray, class Item, class Multiply_fct>
array<Item> scan_exclusive_no_result(Array<Item>& items, TmpArray<Item>& tmp_array, const Item& zero, const Multiply_fct& multiplication) {
...
template <template <class Item> class Array, class Item, class Multiply_fct>
array<Item> scan_exclusive(Array<Item>& items, const Item& zero, const Multiply_fct& multiplication) {
  array<Item> result(items.size());
...
template <template <class Item> class Array, template <class Item> class TmpArray, class Item, class Multiply_fct>
array<Item> scan_inclusive_no_result(Array<Item>& items, TmpArray<Item>& tmp_array, const Item& zero, const Multiply_fct& multiplication) {
...
template <template <class Item> class Array, class Item, class Multiply_fct>
array<Item> scan_inclusive(Array<Item>& items, const Item& zero, const Multiply_fct& multiplication) {
  array<Item> result(items.size() + 1);
